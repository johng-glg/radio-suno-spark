-- Update the get_admin_stats function to include top songs by play count
  ...
  SELECT json_build_object(
    ...
    'top_songs_by_plays', (
      SELECT json_agg(json_build_object(
        ...
        'unique_listeners', COALESCE(plays_data.unique_listeners, 0)
      ) ORDER BY COALESCE(plays_data.total_plays, 0) DESC)
      FROM public.songs s
      LEFT JOIN (
        SELECT 
          song_id,
